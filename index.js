...
fs.mkdir('userniks',()=>{
    fs.readFile('./userniks/verification.txt', 'utf8', function(err) {
        if (err) {
            fs.writeFile('./userniks/verification.txt', '', function(err) {
                if (err) {
    ...
    fs.readFile('./userniks/taitls.txt', 'utf8', function(err) {
        if (err) {
    ...
    fs.readFile('./userniks/length.txt', 'utf8', function(err) {
        if (err) {
            fs.writeFile('./userniks/length.txt', '2', function(err) {
                if (err) {
                    console.log('Ошибка создания базы');
                }
            });
    ...
    fs.readFile('./userniks/i_item.txt', 'utf8', function(err) {
        if (err) {
            fs.writeFile('./userniks/i_item.txt', '0', function(err) {
                if (err) {
                    console.log('Ошибка создания базы');
                }
            });
...
fs.mkdir('tatles',()=>{});
let mas13=['Сезон','Серия','Описание','Название'];
...
app.post('/sear',(req,res) =>{
    let tit = req.body.user;
    
    fs.readFile('./userniks/taitls.txt', 'utf8', function(err,data) {
        if (err) {
            console.log('Ошибка чтения названия тайтла');
        }
        fs.writeFile('./userniks/taitls.txt', data=tit, function(err) {
            if (err) {
                console.log('Ошибка записи названия тайтла');
            }
        });
